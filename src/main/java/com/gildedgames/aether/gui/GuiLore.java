...
public class GuiLore extends HandledScreen
{
    ...
    public GuiLore(net.minecraft.screen.ScreenHandler container2)
    {
        super(container2);
    }
    ...
    protected void drawForeground()
    {
        ...
        this.textRenderer.draw(new StringBuilder().append("Volume ").append(this.type + 1).toString(), 47, 28, 4210752);
        switch (this.type)
        {
            case 0:
            {
    ...
    protected void mouseClicked(int i, int j, int k)
    {
        if (k == 0 || k == 1) {
            ...
            if (var8 != -1) {
                ...
                ItemStack item = this.minecraft.interactionManager.clickSlot(this.container.syncId, var8, k, var9, this.minecraft.player);
...
*/
    ...
    static
    {
        ...
        GuiLore.lores.add(new Lore((Block) Block.GRASS_BLOCK, "Grass", "Found in light.", "Spreads to dirt.", "Flowers and trees", "will grow on it.", "Click with a hoe", "to make farmland", 0));
        ...
        GuiLore.lores.add(new Lore(Item.STONE_HATCHET, "Stone Axe", "Chops wood and ", "planks.", "Slow Speed", "Average Uses", "", "", 0));
        ...
        GuiLore.lores.add(new Lore(new ItemStack(AetherBlocks.MOSSY_HOLYSTONE, 1), "Mossy Holystone", "Found in dungeons.", "Decorative block", "", "", "", "", 2));
